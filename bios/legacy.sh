...
# packages base
base='base base-devel linux linux-firmware sudo networkmanager bluez bluez-utils grub os-prober wpa_supplicant amd-ucode intel-ucode'
...
{
	echo
	title "Install base system for Ice Linux"
	echo
...
install_grub () {
	...
	arch-chroot $chroot grub-install $disk --recheck > $null 2>&1
